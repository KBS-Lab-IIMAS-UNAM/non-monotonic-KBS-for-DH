...
---
Custom queries for retriving specific information of the university KB are defined in `cust_queries_univ.pl`. Inside the session where the KB system is currently active, two custom queries for the university taxonomy are carried out next.
...
---
Through the KB-Service the content of the KB can be updated, added, removed and chaged. Below there are some examples of these services applied to the KB in `kb_university.txt`. 
